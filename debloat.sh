...
exit 1
  ...
  $RM *telnet* apport bpfcc-tools avahi-utils baobab blt bolt docbook-xml *eddy ftp gnome-remote* dleyna-server  friendly-recovery gkbd-capplet gnome-weather icu-devtools modemmanager mtr-tiny mobile-broadband* rtmpdump ruby* rygel *upnp* yelp popsicle* javascript-common whoopsie tcpdump gnome-font-viewer ;

  #OPTIONAL / DISCRETIONARY. Hint: RUN apt info $packagename for what it does.

  # $RM totem* geary pop-shop sane-airscan sane-utils ibus-table-quick-classic ibverbs-providers
  #$RM gnome-accessibility-themes ;
  #$RM cups-browsed cups-pk-helper ;
  #$RM ntfs-3g ;
